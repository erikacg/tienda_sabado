...
export function pintartienda(){
  let productos=[
    ...
    precio:27000,
     ...
     descripcion:"Pin kawaii ¡Agregue una dosis de kawaii a su vida cotidiana con estos llaveros súper lindos de Studio Ghibli! Estas baratijas son perfectas para mostrar tu amor por tus personajes favoritos de Ghibli."
    },

    {nombre:"Ecobolsa mi vecino Totoro",
    precio:53000,
    photo:"img/p-img2.jpg",
    descripcion:"lindo y ecologico Bolsa de algodón de tela ligera de 5 onzas bolsa reutilizable de tela para compras de comestibles, diseños creativos"
    },

    {nombre:"Campanilla de viento Totoro",
    precio:81000,
    photo:"img/p-img3.jpg",
    descripcion:"Tamaño: 18cm ¡Excelente para usar como campanilla de viento, colgador de puerta, decoración de ventana, colgador de espejo retrovisor en su automóvil, o incluso excelente como adorno para el árbol de Navidad! \n\nMaterial: Resina"
    },

    {nombre:"Posters películas 8' x 10'",
    precio:25000, 
    photo:"img/p-img4.jpg",
    descripcion:"Material: propalcote Tamaño:  42x30 cm (16x12 pulgadas)"
  },

    {nombre:"Camiseta Haku",
    precio:96000, 
    photo:"img/p-img5.jpg",
    descripcion:"5.3 onzas, 100 % algodón (99/1 algodón/poliéster (ceniza) y 90/10 algodón/poliéster (gris deportivo) \n\nCamiseta clásica unisex de peso pesado \nCuello y hombros sellados; etiqueta desprendible \nTipo de decoración: Impresión digital "
    },

    {nombre:"Camiseta Viaje de chihiro",
    precio:91000, 
    photo:"img/p-img6.jpg",
    descripcion:"100 % algodón (99/1 algodón/poliéster (ceniza) y 90/10 algodón/poliéster (gris deportivo) \n\nCamiseta clásica unisex de peso pesado \nCuello y hombros sellados; etiqueta desprendible \nTipo de decoración: Impresión digital "
    },

    {nombre:"Colgante Kaonashi- sin cara ",
    precio:40000, 
    photo:"img/p-img7.jpg",
    descripcion:"Tamaño: 18 cm, 15 cm Material: Resina \n\n\nAdvertencia: Mantener alejado del fuego"
    },
    
    {nombre:"Kaonashi varios -sin cara",
    precio:33000, 
    photo:"img/p-img8.jpg",
    descripcion:"Familia kaonashi... Escala: 1/60 \n\n\nMaterial: PVC \n\n\nTamaño: 3-6cm"
    },

    {nombre:"Portalapices Totoro",
    precio:45000, 
    photo:"img/p-img9.jpg",
    descripcion:"para adultos independientes soy un adulto independiente con gustos bien demenstes.... oyoyo de adulto independiente"
    },

    {nombre:"Lampara Kaonashi - sin cara",
    precio:190000, 
    photo:"img/p-img10.jpg",
    descripcion:"Figuras Juguete Luz LED Material: Resina \n\n\nTamaño: 12 cm, 10 cm \n\n\nDimensiones: 10 cm \nAdvertencia: Mantener alejado del fuego"
    }
]
